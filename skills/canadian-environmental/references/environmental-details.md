# Canadian Environmental Compliance Deep Reference

## Carbon Pricing — Facility Compliance Steps (OBPS / TIER)

### Federal OBPS Annual Compliance Cycle
1. **Register** with Environment and Climate Change Canada if facility meets 50,000 tonne threshold
...
## Environmental Assessment Trigger Checklist
...
- [ ] Does the project involve a Class EA category? If yes, screen against the Class EA process.
...
- [ ] Does the project require a permit under EPEA? If yes, EA may be part of the approval process.

---

## Spill Response Plan — Key Elements

Every facility handling hazardous substances should maintain a written Spill Response Plan containing:

**1. Facility Information**
- Site address and contact list (24/7 emergency contacts)
- Description of hazardous substances on site (types, quantities, storage locations)
- Site map showing drains, waterways, and spill containment infrastructure

**2. Notification Procedures**
- Internal notification chain (who calls whom first)
- Regulatory reporting contacts and thresholds:
  - Federal: Environment Canada emergency line
  - Provincial: Province-specific spill hotline
  - CANUTEC: 1-888-226-8832 (for TDG incidents)
- Neighbouring communities / First Nations notification (if applicable)

**3. Immediate Response Actions**
- Stop the source if safe to do so
- Contain the spill (booms, absorbents, berms)
- Prevent spill from reaching drains or waterways
- Account for all personnel and evacuate if necessary
- Do not attempt clean-up of unknown substances without proper PPE and training

**4. Clean-Up Procedures**
- PPE requirements by substance type
- Approved clean-up methods and contractors
- Waste disposal — use licensed hazardous waste carrier and approved facility
- Soil/water sampling requirements after clean-up

**5. Documentation**
- Spill log: date, time, substance, estimated quantity, location, cause
...
- Training records for all personnel who may respond
- Plan review and update after any actual spill

---

## Contaminated Site Liability

Contaminated site liability is one of the most significant environmental risks for property owners and acquirers:

- **Owner/operator liability:** Current owners may be liable for clean-up even if contamination occurred under previous ownership — due diligence in property acquisition is essential
- **Phase I Environmental Site Assessment (ESA):** Desktop review of historical records and site inspection — identifies recognized environmental conditions (RECs)
- **Phase II ESA:** Soil and groundwater sampling to confirm contamination
- **Phase III ESA:** Remediation options assessment
- **Disclosure obligations:** In most provinces, vendors of commercial/industrial land must disclose known contamination
