...
| **B-15** | Climate Risk Management (rev. Mar 7, 2025) | Climate risk governance and management; disclosures phased in from fiscal 2024 (D-SIBs, Canadian IAIGs) and fiscal 2025 (other in-scope FRFIs); Scope 1 and 2 GHG emissions; **Scope 3 deferred to fiscal 2028** (fiscal 2029 for off-balance-sheet AUM), aligned to CSSB standards |
