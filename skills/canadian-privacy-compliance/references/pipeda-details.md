...
PIPEDA does not define a list of sensitive categories, but case law and OPC guidance identify the following as warranting heightened protection:
...
| Right | Requirement |
|-------|------------|
| Access | Respond within 30 days; may extend by 30 days with notice |
| Correction | Correct or annotate if dispute cannot be resolved |
...
Use this structure when drafting or reviewing a corporate privacy policy:

1. **Introduction** — Who we are; why this policy exists.
2. **What information we collect** — Categories with specific examples.
3. **Why we collect it** — Purpose for each category.
4. **How we use it** — Internal uses; third-party uses.
5. **Who we share it with** — Service providers; legal disclosures; business transactions.
6. **International transfers** — Countries/regions; safeguards in place.
7. **How long we keep it** — Retention periods by category.
8. **How we protect it** — Security measures (at an appropriate level of generality).
9. **Your rights** — Access, correction, withdrawal of consent, complaint.
10. **How to contact us** — Privacy Officer name/title, address, email.
11. **Changes to this policy** — How and when we will notify of updates.
...
1. Collecting more information than necessary for stated purpose
2. Retaining data beyond its useful life without a destruction schedule
3. Inadequate safeguards for high-sensitivity data (no encryption at rest)
4. Privacy policies that are vague, buried, or use complex legal language
5. Third-party service providers without written data processing agreements
6. No documented process for responding to individual access requests
7. Breach log not maintained or breaches not assessed for RROSH
